import { GroupEventType, GroupTraits, IdentifyEventType, JsonMap, ScreenEventType, TrackEventType, UserTraits, AliasEventType, SegmentEvent, UserInfoState } from './types';
...
export declare const applyRawEventData: (event: SegmentEvent, userInfo: UserInfoState) => SegmentEvent;
